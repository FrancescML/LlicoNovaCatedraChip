...
Per poder accedir als exercicis proposats t'hauràs de registrar a la plataforma [jutge.org](https://jutge.org). Aquest registre és **gratuït**.
...
## Menú d'exercicis i com presentar la teva solució a un exercici
...
El menú *New Submission* s'utilitza per presentar la teva solució a l'exercici.

Un cop triat l’exercici, hauràs de solucionar-lo utilitzant els coneixements que has après.

Per **dissenyar un circuit solució** farem servir [CircuitVerse](https://circuitverse.org/simulator), una plataforma gratuïta i de codi obert dissenyada per crear i simular circuits lògics digitals en línia.
