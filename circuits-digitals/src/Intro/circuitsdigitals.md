...
|------          |------     |:---:                |------        |
|Buffer |<img src="./Buffer_ANSI_Labelled.png" style="background-color:white; height:80px;"/>   |$A$                        |Retorna el mateix bit|
|NOT    |<img src="./NOT_ANSI_Labelled.png" style="background-color:white; height:80px;"/>      |$\bar{A}$                  |Inverteix el bit|
|AND    |<img src="./AND_ANSI_Labelled.png" style="background-color:white; height:80px;"/>      |$A·B$                      |1 si les dues entrades són 1|
|OR     |<img src="./OR_ANSI_Labelled.png" style="background-color:white; height:80px;"/>       |$A+B$                      |1 si almenys una entrada és 1|
|NAND   |<img src="./NAND_ANSI_Labelled.png" style="background-color:white; height:80px;"/>     |$\overline{A·B}$           |AND invertit (combinació d'AND i NOT)|
|NOR    |<img src="./NOR_ANSI_Labelled.png" style="background-color:white; height:80px;"/>      |$\overline{A+B}$           |OR invertit (combinació d'OR i NOT)|
|XOR    |<img src="./XOR_ANSI_Labelled.png" style="background-color:white; height:80px;"/>      |$A·\bar{B}+\bar{A}·B$      |1 si les entrades són diferents|
|XNOR   |<img src="./XNOR_ANSI_Labelled.png" style="background-color:white; height:80px;"/>     |$(A·B)+(\bar{A}·\bar{B})$  |1 si les entrades són iguals|
...
<img src='./combinacional.png' alt="Circuit combinacional" style="display:block; width:500px; margin:0 auto; border-radius:8px; background-color:white; padding:4px;"/>
...
<img src='./aritmetic.png' alt="Circuit aritmètic" style="display:block; width:400px; margin:0 auto; border-radius:8px; background-color:white; padding:4px;"/>
...
<img src='./sequencial.png' alt="Circuit seqüencial" style="display:block; width:500px; margin:0 auto; border-radius:8px; background-color:white; padding:4px;"/>
