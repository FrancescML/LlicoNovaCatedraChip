...
|------ |------                                        |:---:                      |------
|Buffer |<img src="./Buffer_ANSI_Labelled.png" style="background-color: rgba(255, 255, 255, 1);"/>   |$A$                        |Retorna el mateix bit
|NOT    |<img src="./NOT_ANSI_Labelled.png" style="background-color: rgba(255, 255, 255, 1);"/>      |$\bar{A}$                  |Inverteix el bit
|AND    |<img src="./AND_ANSI_Labelled.png" style="background-color: rgba(255, 255, 255, 1);"/>      |$A·B$                      |1 si les dues entrades són 1
|OR     |<img src="./OR_ANSI_Labelled.png" style="background-color: rgba(255, 255, 255, 1);"/>       |$A+B$                      |1 si almenys una entrada és 1
|NAND   |<img src="./NAND_ANSI_Labelled.png" style="background-color: rgba(255, 255, 255, 1);"/>     |$\overline{A·B}$           |AND invertit (combinació d'AND i NOT)
|NOR    |<img src="./NOR_ANSI_Labelled.png" style="background-color: rgba(255, 255, 255, 1);"/>      |$\overline{A+B}$           |OR invertit (combinació d'OR i NOT)
|XOR    |<img src="./XOR_ANSI_Labelled.png" style="background-color: rgba(255, 255, 255, 1);"/>      |$A·\bar{B}+\bar{A}·B$      |1 si les entrades són diferents
|XNOR   |<img src="./XNOR_ANSI_Labelled.png" style="background-color: rgba(255, 255, 255, 1);"/>     |$(A·B)+(\bar{A}·\bar{B})$  |1 si les entrades són iguals
