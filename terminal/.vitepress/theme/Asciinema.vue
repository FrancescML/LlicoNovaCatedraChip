...
const id = ref("asciinema_" + Math.random().toString(36).substring(7))
...
onMounted(() => {
  import('asciinema-player').then(player => {
    player.create(props.src, document.getElementById(id.value))
  })
});

// el css l'he copiat a sac de node_modules/asciinema-player/dist/bundle/asciinema-player.css
// perquè no savia importar-lo, segur que hi ha alguna forma...
