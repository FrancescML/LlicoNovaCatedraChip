...
Per tant, el temps total $T(n)$ es pot acotar així:
...
De les dues fites, la més important és la segona, ja que ens dóna un límit superior al temps que triga l’algorisme en funció de la mida de l’entrada $n$. Per tant, triant els valors adequats de les constants $a$ i $b$ en funció de $T_a$, $T_i$, $T_c$, $T_l$ i $T_r$, podem reescriure el temps així:
...
que es llegeix "*T d’ena és O gran de ena*" i significa que el temps que triga l’algorisme creix, com a molt, de manera lineal amb la mida de l’entrada $n$.

La lliçó següent presenta aquesta notació de manera més formal i estudia altres tipus de creixement comuns en l’anàlisi d’algorismes.
