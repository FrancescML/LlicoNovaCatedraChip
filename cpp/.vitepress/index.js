export const index = [
    ...
    {
        text: 'Tipus de dades fonamentals',
        collapsed: true,
        items: [
            {
                text: 'Reals',
    ...
    {
        text: 'Subprogrames: funcions i accions',
        collapsed: true,
        items: [
            {
                text: 'Funcions',
    ...
    },
    {
        ...
        items: [
            ...
            {
                text: 'Cues de prioritats',
                link: '/stl/priority_queue.html',
            },
            {
                text: 'Llistes',
                link: '/stl/list.html',
            ...
            {
                text: 'Conjunts i Diccionaris no ordenats',
                link: '/stl/unordered.html',
            },
            {
                text: 'Resum contenidors',
                link: '/stl/resum.html',
            },
            {
                text: 'Ordenació',
            ...
            {
                text: 'Funcions sobre caràcters',
                link: '/stl/cctype.html',
            },
            {
                text: 'Funcions matemàtiques',
                link: '/stl/cmath.html',
            },
            {
                text: 'Fitxers',
                link: '/stl/fstream.html',
            },
            {
